        ...
        additionalQuestions.push(
          {
            name: "isoCodes",
            message: `Enter ISO ${
              answers.type === "isoCountryCode" ? "country" : "language"
            } codes (comma separated):`,
            type: "input",
          },
          {
            name: "isoCodePath",
            message: `Enter the path to a JSON file containing ISO ${
              answers.type === "isoCountryCode" ? "country" : "language"
            } codes:`,
            type: "input",
          },
          ...
          `{
            ...
            ${
              ["isoCountryCode", "isoLanguageCode"].includes(answers.type)
                ? `isoCodes: [${additionalAnswers.isoCodes
                    .split(",")
            ...
            message: "${additionalAnswers.message}",
          }`,
        ],
      });
    }
