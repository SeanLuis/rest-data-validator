...
export class StringStrategy extends ValidationStrategy {
  async execute() {
    ...
    const answers = await inquirer.prompt([
      ...
      {
        name: 'minLength',
        message: 'Enter the minimum length of the string (leave empty for no minimum):',
        type: 'input',
      },
      {
        name: 'maxLength',
        message: 'Enter the maximum length of the string (leave empty for no maximum):',
        type: 'input',
      },
      {
        name: 'regexPattern',
        message: 'Enter a regular expression pattern to validate the string (leave empty for no pattern):',
        type: 'input',
      },
      {
        name: 'message',
